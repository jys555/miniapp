    ...
    <div id="app">
        ...
        <main class="main-content">
            <div id="home-page" class="page">
                <div class="carousel">
                    <div class="carousel-container" id="carousel">
                        <div class="carousel-slide">Special Offer 1</div>
                        <div class="carousel-slide">Special Offer 2</div>
                        <div class="carousel-slide">Special Offer 3</div>
                    </div>
                </div>
            ...
            <div id="categories-page" class="page hidden">
                ...
                <div class="categories-grid" id="all-categories-grid"></div>
            </div>
            
            <div id="product-detail-page" class="page hidden">
                <div class="product-detail-container">
                    <div class="product-images">
                        <img src="https://placehold.co/400x300" alt="Product" class="product-image-main" id="product-image-main">
                        <div class="image-indicators" id="image-indicators"></div>
                    </div>
                    <div class="product-details">
                        <h1 class="product-title" id="product-name">Product Name</h1>
                        <div class="product-prices">
                            <span class="price-discounted" id="product-price-discounted">$0.00</span>
                            <span class="price-original" id="product-price-original"></span>
                            <span class="discount-percentage" id="product-discount"></span>
                        </div>
        ...
        <nav class="navigation">
            <div class="nav-items">
                <a href="#" class="nav-item active-tab" id="nav-home">
    ...
    <script>
        ...
        function loadMockData() {
            state.products = [
                {
                    ...
                    imageUrls: ['https://placehold.co/300x200?text=Headphones'],
                    buyLink: '#'
                },
                {
                    id: '2',
                    ...
                    imageUrls: ['https://placehold.co/300x200?text=Smart+Watch'],
                    buyLink: '#'
                },
                {
                    id: '3',
                    ...
                    imageUrls: ['https://placehold.co/300x200?text=Speaker'],
                    buyLink: '#'
                },
                {
                    id: '4',
                    ...
                    imageUrls: ['https://placehold.co/300x200?text=Phone+Case'],
                    buyLink: '#'
                }
            ];
            ...
            state.categories = [
                ...
                { id: '5', name: 'Sports', icon: 'fas fa-football-ball' },
        ...
        function renderHomePage() {
            ...
            // Render categories for home page
            const homeCategoriesGrid = document.getElementById('categories-grid');
        ...
        function renderProductDetailPage() {
            ...
            productImageMain.src = product.imageUrls[0];
